...
A három branch a forráskód tárgy által megkövetelt három fázisának felel meg (skeleton, proto, grafikus). Itt csak a grafikus branch-et hagytuk, azon van a kód.
